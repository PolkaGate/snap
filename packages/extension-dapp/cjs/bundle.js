...
const index_js_1 = require("./snap/index.js");
const snapList_js_1 = require("./snap/snapList.js");
const utils_js_1 = require("./snap/utils.js");
...
function getWindowExtensions(originName) {
    ...
    const extensions = isSnapOnlyRequested
        ? Object.fromEntries(Object.entries(snapList_js_1.SNAPS).map(([origin, { name }]) => [
            name,
            (0, index_js_1.injectedMetamaskSnap)(origin),
        ]))
        : win.injectedWeb3;
    /** inject snaps into window */
    if (utils_js_1.hasMetamask) {
        Object.entries(snapList_js_1.SNAPS).map(([origin, { name }]) => {
            win.injectedWeb3[name] = (0, index_js_1.injectedMetamaskSnap)(origin);
        });
    }
    if (isSnapOnlyRequested) {
        return Promise
            ...
            .resolve()
            .then(() => (0, util_1.objectSpread)({ name: nameOrHash, version: version || 'unknown' }))
            .catch(({ message }) => {
